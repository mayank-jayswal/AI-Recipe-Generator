...
class Recipe {
    ...
    /**
     * Create a recipe class with nutrition and ingredient
     */
    ...
    /**
     * Get Reciepi ID with ingrediants and nutrition
     */
    ...
    static async findByUserId(userId, filters = {}) {
        let query = `SELECT r.* , rn.calories  FROM recipes r LEFT JOIN recipe_nutrition rn ON r.id = rn.recipe_id WHERE user_id = $1`
        let params = [userId];
        let paramCount = 1;
