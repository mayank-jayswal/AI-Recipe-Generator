...
if(!process.env.GEMINI_API_KEY){
    throw new Error("Missing GEMINI_API_KEY in environment variables , AI features will not work ");
}
...
try {
    ...
    throw new Error(`Failed to generate recipe: ${error.message} please try again later`);
}
};
